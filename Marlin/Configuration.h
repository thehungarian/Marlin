...
#define X_MOTOR_STEP_PER_REV    (360.0 / 1.8)
#define Y_MOTOR_STEP_PER_REV    X_MOTOR_STEP_PER_REV
#define Z_MOTOR_STEP_PER_REV    X_MOTOR_STEP_PER_REV
#define E1_MOTOR_STEP_PER_REV   X_MOTOR_STEP_PER_REV
